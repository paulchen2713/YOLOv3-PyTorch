...
logs = [
    ...
    '2023-05-22-2',
    '2023-06-05-1',
    '2023-06-07-1',  # NOTE the testpoint is 5 for all logs below, NOTE 6-fold: 0, 1
    '2023-06-08-1',  # 2
    '2023-06-08-3',  # 3
    '2023-06-09-1',  # 4
    '2023-06-10-1',  # 5
    '2023-06-13-2',  # NOTE 10-fold: 0, 1
    '2023-06-14-1',  # 2
    '2023-06-15-1',  # 3
    '2023-06-15-2',  # 4
    '2023-06-16-1',  # 5
    ...
    '2023-06-17-2',  # 8
    '2023-06-17-3',  # 9
    '2023-06-18-1',  # NOTE 4-fold: 0
    '2023-06-18-2',  # 1
    '2023-06-18-3',  # 2
    '2023-06-19-1',  # 3
    '2023-06-19-2',  # NOTE 5-fold: 0 + small model-5
    '2023-06-26-1',  # 1 + small model-6
    '2023-06-26-2',  # 2 + small model-7
    '2023-06-27-1',  # 3 + small model-8
    '2023-06-27-2',  # 4 + small model-9
    '2023-06-27-3',  # NOTE 7-fold: 0 + small model-9
    '2023-06-27-4',  # 1 + small model-8
    '2023-06-28-1',  # 2 + small model-9
    '2023-06-28-2',  # 3 + small model-8
    ...
    '2023-07-12-1',  # 1 + small model-11
    '2023-07-12-2',  # 2 + small model-12
    '2023-07-13-1',  # 3 + small model-12
    '2023-07-13-2',  # 4 + small model-10
    '2023-07-13-3',  # 5 + small model-10
    '2023-07-14-1',  # 6 + small model-9
    '2023-07-14-2',  # 7 + small model-9
]
