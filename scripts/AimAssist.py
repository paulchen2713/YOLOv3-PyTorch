...
def GetOutline(im, bbox):
	...
	for i in range(0, len(color)):
        # NOTE thesholds need further test
...
def main(key, xbbox, ybbox, FPS=60, AutoAdjust=True, Debug=False):
	"""
    ...
    Example: 0x42
        ...
        Format: integer
    Example: 150
        larger values require more processing time, and may cause two enemies to be in view at the same time.
...
if __name__ == "__main__":
    key = 0x60 # Numeric keypad 0 key, 0x42 # b key
    xbbox = 50 # 200
    ybbox = 50 # 200
    FPS = 60
    AutoAdjust = True
