...
# new-anchors-0628-split5.txt
# ANCHORS = [
#     [(0.2748, 0.0443), (0.1759, 0.0859), (0.3936, 0.0978)],
#     [(0.0901, 0.0192), (0.0467, 0.0427), (0.1461, 0.0320)],
#     [(0.0349, 0.0039), (0.0156, 0.0181), (0.0390, 0.0117)],
# ]

# new-anchors-0628-split6.txt
# ANCHORS = [
#     [(0.2274, 0.0401), (0.2076, 0.0923), (0.4134, 0.0930)],
#     [(0.0344, 0.0392), (0.1293, 0.0256), (0.1059, 0.0639)],
#     [(0.0348, 0.0039), (0.0311, 0.0111), (0.0713, 0.0181)],
# ]

### NOTE 8-fold
# new-anchors-0711-split0.txt
# ANCHORS = [
#     [(0.2747, 0.0455), (0.1894, 0.0898), (0.4025, 0.0969)],
#     [(0.0906, 0.0195), (0.1723, 0.0263), (0.1095, 0.0437)],
#     [(0.0324, 0.0079), (0.0382, 0.0186), (0.0339, 0.0502)],
# ]
...
# ANCHORS = [
#     [(0.1536, 0.0770), (0.2510, 0.0935), (0.4394, 0.0928)],
#     [(0.1118, 0.0223), (0.0613, 0.0591), (0.1983, 0.0357)],
#     [(0.0346, 0.0039), (0.0348, 0.0104), (0.0449, 0.0239)],
# ]

# new-anchors-0711-split3.txt
# ANCHORS = [
#     [(0.2280, 0.0379), (0.1948, 0.0901), (0.4074, 0.0939)],
#     [(0.0401, 0.0535), (0.1162, 0.0210), (0.1137, 0.0464)],
#     [(0.0156, 0.0165), (0.0372, 0.0077), (0.0502, 0.0189)],
# ]

# new-anchors-0711-split4.txt
# ANCHORS = [
#     [(0.2514, 0.0422), (0.2246, 0.0953), (0.4238, 0.0955)],
#     [(0.0555, 0.0463), (0.1410, 0.0278), (0.1328, 0.0724)],
#     [(0.0333, 0.0088), (0.0232, 0.0282), (0.0770, 0.0182)],
# ]

# new-anchors-0711-split5.txt
# ANCHORS = [
#     [(0.2761, 0.0455), (0.2165, 0.0950), (0.4193, 0.0967)],
#     [(0.0446, 0.0495), (0.1589, 0.0297), (0.1259, 0.0693)],
#     [(0.0312, 0.0083), (0.0432, 0.0189), (0.0977, 0.0209)],
# ]

# # new-anchors-0711-split6.txt
# ANCHORS = [
#     [(0.1283, 0.0710), (0.2229, 0.0949), (0.4213, 0.0932)],
#     [(0.0442, 0.0503), (0.1218, 0.0247), (0.2275, 0.0393)],
#     [(0.0181, 0.0162), (0.0393, 0.0083), (0.0576, 0.0192)],
# ]

# new-anchors-0711-split7.txt
ANCHORS = [
    [(0.2519, 0.0427), (0.2122, 0.0932), (0.4178, 0.0955)],
    [(0.0786, 0.0184), (0.1418, 0.0275), (0.1120, 0.0653)],
    [(0.0349, 0.0039), (0.0310, 0.0111), (0.0368, 0.0370)],
]
...
if __name__ == "__main__":
    ...
    print(f"test() from config.py has been disabled\n")
