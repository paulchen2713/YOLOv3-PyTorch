...
log_file_name = '2023-07-13-2' # TODO date_function.today() 
...
if __name__ == "__main__":
    ...
    # NOTE 8-fold
    # 2023-07-13-2  epoch: 100   duration:   hours  WEIGHT_DECAY = 1e-4  LEARNING_RATE = 15e-5  max mAP:  0.  ##split 4 + smaller model-10
