...
log_file_name = '2023-07-13-3' # TODO date_function.today() 
...
if __name__ == "__main__":
    ...
    # 2023-07-14-1  epoch: 100   duration:   hours  WEIGHT_DECAY = 1e-4  LEARNING_RATE = 15e-5  max mAP:  0.  ##split 6 + smaller model-9
