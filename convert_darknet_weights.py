...
if __name__ == "__main__":
    ...
    # the "yolov3.weights" should be put in the specified directory
    WEIGHT_PATH = "D:/Datasets/YOLOv3-PyTorch/YOLOv3-pretrained-weights/darknet_format/"
    model.load_darknet_weights(weights_path=WEIGHT_PATH + "yolov3.weights")
